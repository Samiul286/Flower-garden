...
function createPlane() {
	...
	let tex1 = texloader.load(tex1_b64);
	let tex2 = texloader.load(tex2_b64);
	let tex3 = texloader.load(tex3_b64);
	let tex4 = texloader.load(tex4_b64);
	let tex5 = texloader.load(tex5_b64);
	let tex6 = texloader.load(tex6_b64);
	let tex7 = texloader.load(tex7_b64);
	let tex8 = texloader.load(tex8_b64);
	let tex9 = texloader.load(tex9_b64);
	let tex10 = texloader.load(tex10_b64);
	...
	shaderMaterial = new THREE.ShaderMaterial({
		uniforms: {
			...
			u_flower3: { type: 't', value: tex3 },
			u_flower4: { type: 't', value: tex4 },
			u_flower5: { type: 't', value: tex5 },
			u_flower6: { type: 't', value: tex6 },
			u_flower7: { type: 't', value: tex7 },
			u_flower8: { type: 't', value: tex8 },
			u_flower9: { type: 't', value: tex9 },
			u_flower10: { type: 't', value: tex10 },
